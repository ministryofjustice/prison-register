...
enum class AuditType {
  ...
  APPROVED_PREMISES_REGISTER_INSERT,
  APPROVED_PREMISES_REGISTER_UPDATE,
  APPROVED_PREMISES_REGISTER_DELETE,
  APPROVED_PREMISES_REGISTER_ADDRESS_INSERT,
  APPROVED_PREMISES_REGISTER_ADDRESS_UPDATE,
  APPROVED_PREMISES_REGISTER_ADDRESS_DELETE,
  APPROVED_PREMISES_REGISTER_PHONE_INSERT,
  APPROVED_PREMISES_REGISTER_PHONE_UPDATE,
  APPROVED_PREMISES_REGISTER_PHONE_DELETE,
  APPROVED_PREMISES_REGISTER_EMAIL_INSERT,
  APPROVED_PREMISES_REGISTER_EMAIL_UPDATE,
  APPROVED_PREMISES_REGISTER_EMAIL_DELETE,
