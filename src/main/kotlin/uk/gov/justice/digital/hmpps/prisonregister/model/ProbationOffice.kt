...
data class ProbationOffice(
  ...
  @JoinTable(
    name = "probation_office_to_agency_address",
    joinColumns = [JoinColumn(name = "probation_office_id")],
  ...
  @OneToMany(cascade = [CascadeType.ALL], orphanRemoval = true)
  @JoinTable(
    name = "probation_office_to_email_address",
    joinColumns = [JoinColumn(name = "probation_office_id")],
  ...
  @OneToMany(cascade = [CascadeType.ALL], orphanRemoval = true)
  @JoinTable(
    name = "probation_office_to_phone",
    joinColumns = [JoinColumn(name = "probation_office_id")],
  ...
  override fun equals(other: Any?): Boolean {
    ...
    other as ProbationOffice

    return probationOfficeId == other.probationOfficeId
  }

  override fun hashCode(): Int = javaClass.hashCode()

  @Override
  override fun toString(): String = this::class.simpleName + "(probationOfficeId = $probationOfficeId, name = $name, description = $description"
  override fun getId(): String? = probationOfficeId
  override fun isNew(): Boolean = new
}

enum class AccessibleAccess {
  NONE,
  ACCESSIBLE,
  BY_ARRANGEMENT_ONLY,
  WHEELCHAIR_ACCESS,
